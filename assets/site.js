(() => {
  ...
  const equations = [
    ...
    { lines: ["ℒ_PPO = 𝔼[min(rₜAₜ,", "clip(rₜ,1−ε,1+ε)Aₜ)]"] },
    { lines: ["Aᵢ = (Rᵢ − μ_R)", "/ (σ_R + ε)"] },
    { lines: ["J_GRPO = 𝔼[∑ᵢ ρᵢAᵢ/G", "− β D_KL(π‖π_ref)]"] },
    { lines: ["q(xₜ|x₀) = 𝒩(", "√ᾱₜ x₀, (1−ᾱₜ)𝐈)"] },
    { lines: ["ℒ_diff = 𝔼[‖ε −", "ε_θ(xₜ,t)‖²]"] },
    { lines: ["∇_θ J = 𝔼[", "∇ log π_θ(a|s) · A]"] },
